...
public class Kurth extends Fighter
{
	...
	private static final int BLOCKED_PUNCH = 3;
	...
	private static final int KICK_UPDATE_COUNT = 180 / (int) ((double) 1/3 * KICK_ANIMATION_COUNT); // makes it kick twice in a second
