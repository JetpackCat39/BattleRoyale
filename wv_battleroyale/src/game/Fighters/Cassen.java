...
public class Cassen extends Fighter
{
	...
	private static final int PUNCH = 11;
	private static final int BLOCKED_PUNCH = 1;
	private static final int KICK = 11;
	...
	public Cassen(int newX, int newY, BufferedImage spriteSheet, BufferedImage worl, boolean isPlayer1, PlayerControls c)
	{
