...
public class FighterMenu extends Screen
{
	...
	public void setP1() throws IOException
	{
		...
		case "JAMAL":
			...
			break;
		case "CASSEN":
			p1 = new Cassen(PLAYERX, PLAYERY, GUIUtils.self().loadImage("Images/Cassen-Ingame.png"), null, true,
					p1Controls);
			break;
		case "TOMBOC":
	...
	public void setP2() throws IOException
	{
		...
		case "JAMAL":
			...
			break;
		case "CASSEN":
			p2 = new Cassen(width - PLAYERX, PLAYERY, GUIUtils.self().loadImage("Images/Cassen-Ingame.png"), null,
					false, p2Controls);
			break;
		case "TOMBOC":
