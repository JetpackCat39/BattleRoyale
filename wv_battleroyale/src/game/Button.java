...
public class Button extends RoundRectangle2D.Double implements IDrawable
{
	...
	{
		this(x, y, DEFAULT_WIDTH, DEFAULT_HEIGHT, text);
	}
	...
	{
		draw(g, Color.white, Color.decode("#4d4d4d"), buttonText, 32);

	}
	
	public void draw(Graphics g, Color color, Color tColor, String text, int fontSize)
	{
		g.setColor(color);
